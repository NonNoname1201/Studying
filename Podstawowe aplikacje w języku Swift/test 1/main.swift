...
// if(s.hasPrefix("Ala")) {
//     print("s zaczyna się od Ala")
// }

// if(s.hasSuffix("kota")) {
//     print("s kończy się na kota")
// }
...
// print(s.[s.index(s.endIndex, offsetBy: -3)])

// s.insert("Y", at: s.startIndex)

// s.insert(contentsOf: "ABC", at: s.index(s.startIndex, offsetBy: 2))

// s.remove(at: s.index(s.startIndex, offsetBy: 2))

// let range = s.index(s.startIndex, offsetBy: 2)..<s.index(s.startIndex, offsetBy: 5)
// s.removeSubrange(range)

// //delete character A
// if let range = s.range(of: "A") {
//     s.removeSubrange(range)
// }

// for i in 0..<s.count {
//     if(s.[s.index(s.startIndex, offsetBy: i)] == "k"){
//         print("Znaleziono na pozycji \(i)")
//     }
// }

// var d = 3456789.123456789
// print(String(format: "%.2f", d))
